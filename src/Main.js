        ...
        <div className="one">
          <div className="inner-one">
            ...
            <div className="input">
              ...
              <span>
                <input type="text" placeholder="0" value={bill} onChange={e => setBill(+e.target.value)} />
              </span>
            </div>
          </div>
          ...
          <div className="inner-three">
            ...
            <div className="input-two">
              ...
              <span>
                <input type="text" id="peeps" placeholder="0" value={people} onChange={e => setPeople(+e.target.value)} />
              </span>
            </div>
          </div>
        </div>
